defmodule LiveScheduleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveScheduleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveScheduleWeb.Gettext, "errors", msg, opts)
    end
  end
